...
exports.getAccidentById = exports.getAccidents = void 0;
const axios_1 = __importDefault(require("axios"));
const getAccidents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getAccidentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
